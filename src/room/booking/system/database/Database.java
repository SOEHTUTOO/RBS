...
public class Database {
    ...
    private void createTB () throws SQLException {
        ...
        String createRecordTB = "create table if not exists rbsdb.records (room_id varchar(50), foreign key (room_id) references rooms(id), visitor_passport varchar(50), foreign key (visitor_passport) references visitors(passport), member_id varchar(30), foreign key (member_id) references members(id))";
